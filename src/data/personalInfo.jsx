export const personalInfo = {
  ...
  description: "I transform complex problems into elegant, user-friendly solutions. With expertise across mobile and web development, I build applications that are both beautiful and functional.",
